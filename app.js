...
(function(){
  var fs, getsecret, koa, koaStatic, koaRouter, koaLogger, glob, on_heroku, selfSignedHttps, debounce, ref$, cfy, yfy, add_noerr, kapp, app, bodyParser, session, passport, SUSamlStrategy, saml, auth, memoizeSingleAsync, sleep, to_dict_list, creds, get_sheet, get_spreadsheet_real, get_spreadsheet, get_seminars_attended_by_user, list_all_users, index_contents, serve_static, i$, len$, port;
  fs = require('fs');
