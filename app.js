...
(function(){
  ...
  app.get('/saml/consume', passport.authenticate('saml', {
    successRedirect: '/secret',
    failureRedirect: '/'
  }), function*(){
    return this.redirect('/secret');
