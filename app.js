...
(function(){
  ...
  */
  ...
  app.post('/saml/consume', passport.authenticate(saml.name), function*(){
    var url;
    if (this.session) {
      url = this.session.authReturnUrl;
      delete this.session.authReturnUrl;
  ...
  app.get('/login', passport.authenticate(saml.name), function*(){
    var url;
    if (this.session) {
      url = this.session.authReturnUrl;
      delete this.session.authReturnUrl;
